/**
* BeaconDemo for Gentlestudent
* https://github.com/ismakutl/Gentlestudent
*/
...
const IDENTIFIER = 'ddbb003748296cf8b147bc74b56f530e';
...
class BeaconsDemo extends Component {
	...
	componentDidMount() {
		...
		this.regionDidEnterEvent = Beacons.BeaconsEventEmitter.addListener(
			'regionDidEnter', ({uuid, identifier}) => {
